...
// readFile loads the entire file into memory at once, so a large file can use
// a lot of memory. A stream processes the file in smaller chunks, so it uses
// much less memory and keeps peak memory usage relatively flat as file size grows.
